...
output "mssql_database_encryption_keys" {
  ...
  value       = try(module.replicated_mssql.mssql_database_encryption_keys, {})
}
...
output "mssql_threat_detection_policies" {
  ...
  value       = try(module.replicated_mssql.mssql_threat_detection_policies, {})
}
...
output "mssql_extended_auditing_policies" {
  ...
  value       = try(module.replicated_mssql.mssql_extended_auditing_policies, {})
}

output "mssql_resource_group_name" {
  description = "The name of the resource group where the MSSQL Server is deployed."
  value       = module.replicated_mssql.mssql_resource_group_name
}
